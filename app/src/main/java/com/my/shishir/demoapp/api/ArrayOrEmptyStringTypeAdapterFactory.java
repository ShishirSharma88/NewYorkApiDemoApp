...
import static com.my.shishir.demoapp.api.ArrayOrEmptyStringTypeAdapter.getArrayOrEmptyStringTypeAdapter;

public final class ArrayOrEmptyStringTypeAdapterFactory
    ...
    public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> typeToken) {
        if (List.class.isAssignableFrom(typeToken.getRawType())) { // Is it an instance of java.util.List? Not that getRawType() and getType() have different purposes
            ...
            @SuppressWarnings("unchecked") final TypeAdapter<T> castTypeAdapter = (TypeAdapter<T>) typeAdapter;
